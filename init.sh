...
touch /home/ec2-user/$INSTANCE_ALREADY_STARTED
  ...
  docker version
  /home/ec2-user/.docker/cli-plugins/docker-compose -f /home/ec2-user/mikl.io/docker-compose.yaml pull
  /home/ec2-user/.docker/cli-plugins/docker-compose -f /home/ec2-user/mikl.io/docker-compose.yaml up -d
else
  echo "-- Not first instance startup --"
  sudo yum update -y
  if [ "$(cat /home/ec2-user/mikl.io/stop.txt)" = stop ]; then
    /home/ec2-user/.docker/cli-plugins/docker-compose -f /home/ec2-user/mikl.io/docker-compose.yaml down --remove-orphans
  fi
  /home/ec2-user/.docker/cli-plugins/docker-compose -f /home/ec2-user/mikl.io/docker-compose.yaml pull
  /home/ec2-user/.docker/cli-plugins/docker-compose -f /home/ec2-user/mikl.io/docker-compose.yaml up -d
fi
